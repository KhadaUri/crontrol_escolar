                            ...
                            <div class="card-body">
                                ...
                                <div class='container'>
                                    <table id="tab_proyectos" width="70%" class='table'>
                                        ...
                                        $sentencia="SELECT usuario.id_usuario,materias.id_materia,materias.nombre_materia FROM materias INNER JOIN usuario ON materias.id_curso=usuario.id_curso WHERE usuario.id_usuario = '$id_usuario'";
                                                $res=$cnx->query($sentencia);
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="view-profesor-calificacion.php?id_usuario=<?php echo $registro['id_usuario'];?>"><button type="button id="link" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a></td>
                                        </tr>
