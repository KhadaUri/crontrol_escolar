...
require 'conexion.php';
  $sentencia = "SELECT id_curso FROM calificaciones WHERE nombre = '$id_usuario'";
                            ...
                            <div class="card-body">
                                ...
                                <div class='container'>
                                    <table id="tab_proyectos" width="100%" class='table'>
                                        <thead>
                                            <tr>
                                                <th scope='col' class='titulo'>CURSO <?php echo $id_usuario ?></th>
                                               <!-- <th scope='col' class='titulo'>MATERIA<?php echo $registro['id_usuario']?></th>-->
                                                <th scope='col' class='titulo'>MATERIA <?php echo $row['id_curso'];?></th>
